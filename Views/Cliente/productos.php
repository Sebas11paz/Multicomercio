...
if($busqueda !=""){
    $productos = $object->getProductosCategoria($busqueda);
}else{
    $productos = $object->getTodos();
}

$categorias = new Categorias();
$opciones = $categorias->getTodos();
$respaldo=[];
$busqueda="";
    ...
    <div class="container d-flex my-3">
        <div class="col d-flex">
            <div class="btn-group">
                ...
                ?>
                    <li><a class="dropdown-item" href="<?php echo "/productos/categoria/".$iten["nombre"]; ?>"><?php echo $iten["nombre"]; ?></a></li>
                <?php
                }
                ?>
                </ul>
        ...
        <div class="col">
            <form class="d-flex" action="/productos/todos" method="post">
